...
public class SeckillOrderServiceImpl implements SeckillOrderService {
    ...
    public PageResult findPage(int pageNum, int pageSize) {
        ...
        Page<SeckillOrder> page = (Page<SeckillOrder>) seckillOrderMapper.selectByExample(null);
    ...
    public PageResult findPage(SeckillOrder seckillOrder, int pageNum, int pageSize) {
        ...
        Page<SeckillOrder> page = (Page<SeckillOrder>) seckillOrderMapper.selectByExample(example);
        return new PageResult(page.getTotal(), page.getResult());
    }
    ...
    public void submitOrder(Long seckillId, String userId) {
        ...
        if (seckillGoods.getEndTime().getTime() < System.currentTimeMillis()) {
            throw new RuntimeException("你抢晚了");
        }
